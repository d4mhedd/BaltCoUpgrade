/*------------------------------------------------------------------------------------------------------/
| Program: RentalRegistrationExpire 1.0.js  Trigger: Batch    Client : Baltimore County, MD
| 
| Version 1.0 
|
...
var licenseStatus = "About To Expire";	// "About to Expire".  Statuses to process,comma separated (GG 7/10/2013 - changed to Active from Pending1) 

var lookAheadDays = "00";   //NOT a Param		// Number of days from today {30} 
var daySpan = "1";		  //NOT a Param	// Days to search {1} 

var newRenewalStatus =  "Delinquent";//  "Expired".  Change renewal status to this
//var newAppStatus = "Expired";	// "Renewal".  Change App Status to this Pending (gg 7/17/2013 This will change the Application once in application acceptance status)
var editWorkflowTask = "License Status";// "License Issuance"  Open this task, set it to License Status (GG 7/29/2013)
var editWorkflowStatus = "Expired"; //   "Renewal"
       ...
       // ET Turned off 6/16
		...
		if (editWorkflowTask.length)
		{
			...
			if (editWorkflowStatus.length && wfCode != "") //then update statuses
			{
				...
				loopTask("License Status", "Expired", "Updated by Batch Job: "+batchJobName, "Updated by Batch Job: "+batchJobName, wfCode);
