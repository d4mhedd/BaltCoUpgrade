...
| - Not ran in 2014. Mailed letters out to everyone. ET
	HISTORY
	====================
...
var licenseStatus = "Active,Issued";	// "Active".  Statuses to process,comma separated (GG 7/10/2013 - changed to Active from Pending1) 

var lookAheadDays = "90";   //NOT a Param		// Number of days from today {90} (GG 7/10/2013 - added 90 days) 
var daySpan = "7";		  //NOT a Param	// Days to search {7} (GG 7/10/2013 - added 7 days) 

var newRenewalStatus = "Active";//  "About To Expire".  Change renewal status to this {GG 7/17/2013 changed from Renewal to "About To Expire"
var newAppStatus = "Issued";	// "Renewal".  Change App Status to this {gg 7/17/2013 removed workflow sets app status
...
var fromDate = "1/05/" + currentYear;		// 6/18/current year
var toDate = "4/05/" + currentYear;			// 6/18/current year
...
var mSubjEn = "Baltimore County Residential Parking License Confirmation";
var mSubjAr = "";
var mMesgEn = "This is a email confirming your Baltimore County Residential Parking License " + capIDString + " .";
var mMesgAr = "";
...
// Send SMS and E-mail to Applicant
		...
		for (thisCon in conArray)
		{
			...
			if (b3Contact["contactType"] == "Applicant")
			{
				...
				if (conEmail && sendEmailNotifications.substring(0,1).toUpperCase().equals("Y")) aa.sendMail("accelainfo@baltimorecountymd.gov", conEmail, "", mSubjEn + " " + mSubjAr,mMesgEn + " " +  mMesgAr);
			}
