/*------------------------------------------------------------------------------------------------------/
| Program: RESPARKINGRenewal 1.0.js  Trigger: Batch    | 
| Version 1.0 
|
...
| - Modified to update workflow and email contact about renewing. 6/17/2014
| - Added Logic and variable for hyperlink in email string ET 6/20/2014
	HISTORY
	====================
...
/------------------------------------------------------------------------------------------------------*/
var appGroup = "MiscPermits";			//   "Licenses"  app Group to process.  (GG 7/10/2013 - changed to License from Licenses)
var appTypeType = "Residential Parking";			//   "Animal"  app type to process.
var appSubtype = "Residential Parking Permit";			//   app subtype to process, *  (GG 7/10/2013 - added Pet)
var appCategory = "Permit";			//   app category to process, e.g. *  (GG 7/10/2013 - added NA)
...
var newRenewalStatus = "About To Expire";//  "About To Expire".  Change renewal status to this {GG 7/17/2013 changed from Renewal to "About To Expire"
var newAppStatus = "Renewal";	// "Renewal".  Change App Status to this {gg 7/17/2013 removed workflow sets app status
var editWorkflowTask = "Issuance";// "License Issuance"  Open this task, set it to 
var editWorkflowStatus = "About to Expire"; //   "Renewal"
...
var fromDate = "6/05/" + currentYear;		// 6/18/current year
var toDate = "8/05/" + currentYear;			// 6/18/current year
...
var str = "Residential Parking Permit Site";
var result = str.link("http://www.baltimorecountymd.gov/Agencies/permits/pdm_miscperm/residentialparking.html");

var mSubjEnConstant = null;
var mMesgEnConstant = null;
var mSubjArConstant = null;
var mMesgArConstant = null;
var mSubjEn = "It is Time To Renew Your Baltimore County Residential Parking Permit";
var mSubjAr = "";
var mMesgEn = "It is time to renew your residential parking permit. Your current permit expires on July 31.<br/><br/>We encourage you to renew your parking permit online; which is easier, faster and more convenient than paper-based renewals. Within the next week, you will receive information pertaining to your current permit as well as renewal instructions.<br/><br/>For more information visit Baltimore County's " + result + ".<br/><br/>This is a system-generated email. Do Not Reply.";
var mMesgAr = "";
...
// Send SMS and E-mail to Applicant
		...
		if (editWorkflowTask.length)
		{
			...
			if(appSubType=="Residential Parking Permit")
			{ 
				wfCode = "PI_PMST_RES";
			}
			...
			if (editWorkflowStatus.length && wfCode != "") //then update statuses
			{
				...
				updateTask("Issuance", "About to Expire", "Updated by Batch Job: "+batchJobName, "Updated by Batch Job: "+batchJobName, capId);
