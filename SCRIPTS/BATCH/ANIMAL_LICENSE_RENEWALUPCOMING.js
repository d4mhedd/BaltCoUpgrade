/*------------------------------------------------------------------------------------------------------/
| Program: PetLICENSERenewal 1.0.js  Trigger: Batch    | 
| Version 1.0 
|
...
| - Added logic to send email to contact Applicatant to get bounce backs  Eric Tenney 3/7/2014
...
var lookAheadDays = "30";   //NOT a Param		// Number of days from today {90} (GG 7/10/2013 - added 90 days) 
var daySpan = "30";		  //NOT a Param	// Days to search {7} (GG 7/10/2013 - added 7 days) 

var newRenewalStatus = "Pending";//  "About To Expire".  Change renewal status to this  et update to same status 2014
var newAppStatus = "Issued";	// "Renewal".  Change App Status to this {gg 7/17/2013 removed workflow sets app status et update to same status 2014
var editWorkflowTask = "License Issuance";// "License Issuance"  Open this task, set it to 
var editWorkflowStatus = "Issued-Bouncesent"; //   "Renewal"

var workflowFlowCode = "LICPET"; // //NOT a Param.  Values are LICPET or LICFACILITY
var openWorkflowTask = "License Issuance"; // NONE - //NOT a Param
...
var mSubjEn = "Baltimore County Animal License Renewal Begins May 1 for";
var mSubjAr = "";
var mMesgEn = "";
var mMesgAr = "";
...
// Send SMS and E-mail to Pet Owner
		...
		for (thisCon in conArray)
		{
			...
			if (b3Contact["contactType"] == "Pet Owner")
			{
				...
				if (conEmail && sendEmailNotifications.substring(0,1).toUpperCase().equals("Y")) aa.sendMail("noreplybaltco@baltimorecountymd.gov", conEmail, "", mSubjEn + " " + capIDshow + " " + mSubjAr,mMesgEn + "Your Baltimore County animal license " + capIDshow + " will expire on June 30, 2014.<br/><br/>The annual renewal period begins May 1. At that time, you will receive an email with the information you need to renew online. You do not need to take action yet.<br/><br/>To learn more about animal licensing, please visit www.baltimorecountymd.gov/animallicense.<br/><br/>You received this message because you either applied for an animal license online last year or provided your email address on a paper animal license application.<br/><br/>This is a system-generated email. DO NOT REPLY. " +  mMesgAr);
			}
		...
		if (editWorkflowTask.length)
		{
			...
			if (editWorkflowStatus.length && wfCode != "") //then update statuses
			{
				...
				updateTask("License Issuance", "Issued-Bouncesent", "Updated by Batch Job: "+batchJobName, "Updated by Batch Job: "+batchJobName, capId);
