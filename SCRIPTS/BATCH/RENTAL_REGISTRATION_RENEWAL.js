/*------------------------------------------------------------------------------------------------------/
| Program: RentalRegistrationRenewal 1.0.js  Trigger: Batch    Client : Baltimore County, MD
| 
| Version 1.0 
|
...
//aa.env.setValue("emailAddress", "rvonschoech@accela.com")	
...
var appSubtype = "Registration";			//   app subtype to process, *  (GG 7/29/2013 - added Registration)
	...
	for (zzz in myExp)  // for each b1expiration (effectively, each license app)
	{
		...
		if (newRenewalStatus.length)
		{
			...
			expDateString = expDate.getMonth() + "/" + expDate.getDayOfMonth() + "/" + expDate.getYear(); 
                ...
                var emailSubj = "Baltimore County Rental Registration License About To Expire";
        var emailText = "";
        realemailAddress = "";
        ...
        emailText = "This is a reminder that your Rental Registration License will expire on " + expDateString + ". This is a system generated email. DO NOT REPLY.";
       ...
       // ET Turned off 6/16
		...
		if (editWorkflowTask.length)
		{
			...
			if(appSubType=="Registration")    //changed from pets GG 7/31/2013
			{ 
		...
		// GG -7/17/2013 not needed as workflow will update app status
