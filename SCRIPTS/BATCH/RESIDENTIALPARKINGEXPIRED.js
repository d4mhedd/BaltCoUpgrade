...
//aa.env.setValue("BatchJobName", "Res Parking Expire");
...
// 11/18/2011 - Updated licenseObject function.  Added " to the licenseStatus Array list to fix NULL POINTER bug
//  11/22/2011 - Extended the timeout to 8 hours

| Program: AnimalLicenseExpire 1.0.js  Trigger: Batch    
| 
| Version 1.0 
| Eric Tenney- Cloned and modified animal license expire script
...
/------------------------------------------------------------------------------------------------------*/
var appGroup = "MiscPermits"; //   "Licenses"  app Group to process.   (GG 7/17/2013 Changed from Licenses to License)
var appTypeType = "Residential Parking"; //   "Animal"  app type to process.
var appSubtype = "Residential Parking Permit"; //   app subtype to process, *  (GG 7/17/2013 - added Pet)
var appCategory = "Permit"; //   app category to process, e.g. * (GG 7/17/2013 - added NA)
...
var lookAheadDays = "0"; //NOT a Param		// Number of days from today {90}(GG 7/17/2013 - added 90 days) 
...
var expireDate = "7/31/" + currentYear; // 6/30/current year (GG 7/17/2013 change to 07/05
