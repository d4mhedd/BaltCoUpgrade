...
if ((currentUserGroup != "EnforcementPublicUser" || currentUserGroup != "PublicUser" ) &&wfTask==("Intake") && wfStatus ==("Duplicate")) {
...
if (wfTask == "Intake" && wfStatus == "Inspection Scheduled") {
	scheduleInspectDate("Initial Inspection",nextWorkDay(),null, null, "Scheduled via Workflow");
