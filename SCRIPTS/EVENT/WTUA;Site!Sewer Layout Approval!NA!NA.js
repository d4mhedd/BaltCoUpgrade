//WTUA;Site!Sewer Layout Approval!NA!NA
;
...
if (wfTask == "Review Consolidation" && wfStatus == "Approved" && AInfo['siteBlgRequired'] == "No") {
	var params = aa.util.newHashMap();
	WFMODULE.displayReportFromWorkflow("Notice of Project Approval", params);
	}
