...
if (wfTask==("Development Plan Decision") && (wfStatus ==("Approved") || wfStatus ==("Disapproved") || wfStatus ==("Approved with Conditions") )) {
	closeTask("Development Plan Review","Completed","Closed via Script","","PRMINOR");
	}
...
if (wfTask==("Board of Appeals Hearing") && wfStatus ==("No Appeal")) {
	...
	closeTask("Appeals Process","Completed","Closed via Script","","PRMINOR");
	}
...
if (wfTask==("Final Approval Processing") && wfStatus ==("Resubmit Development Plan") && isTaskActive("Closure") && isTaskActive("Final Approval Processing")) {
	deactivateTask("Closure");
...
if (wfTask==("Board of Appeals Hearing Decision") && (wfStatus ==("Community Appeal Denied") || wfStatus ==("Developer Appeal Denied"))) {
	closeTask("Appeals Process","Appeal Denied","update via Script","","PRMINOR");
	}
