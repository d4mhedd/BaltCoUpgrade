function licenseObject(licnumber,parentCap)  // optional renewal Cap ID -- uses the expiration on the renewal CAP.
	{
	itemCap = capId;
	...
	if (licnumber) // we're linking
   	...
   	this.setExpiration = function(expDate)
   		...
   		if (this.refProf) 
        {
            /* Commented out by RN on 10/19/2011
